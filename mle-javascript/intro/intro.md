...
In this workshop you will use JavaScript, powered by Multilingual Engine (MLE), to create an APEX social media app. Its main feature is the analysis of the uploaded photos using AI. You will use
...
- Use JavaScript instead of PL/SQL, to process the data

In the process you will familiarize yourself with JavaScript as an ideal companion to PL/SQL and APEX development.
...
- Configure AI Services and JSON Source
- Import third-party JavaScript modules into the database and create the environment
