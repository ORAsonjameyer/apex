...
Oracle APEX is a modern low-code application platform for Oracle AI Database. Oracle APEX Application Development (APEX Service) and Oracle Autonomous AI Database services provide managed, preconfigured cloud environments with APEX ready to build, run, and evolve data-driven applications directly in the browser. To start this workshop, choose the Oracle Cloud service that fits your environment, then create an APEX workspace accordingly.

For this MLE workshop, APEX is the application layer and Oracle Multilingual Engine is the execution layer for JavaScript inside Oracle AI Database. You will combine declarative APEX components with SQL, PL/SQL, REST integrations, and database-resident JavaScript through MLE to build data-centric applications where UI, workflow, security, and server-side logic stay close to the data.

If you already have an APEX 26.1 Workspace provisioned on Oracle AI Database 26ai, you can skip this lab.

Estimated Time: 5 minutes

### What is an APEX Workspace?
An APEX Workspace is a logical development environment where you build and manage APEX applications. Each workspace is associated with one or more database schemas that contain the application’s database objects, such as tables, views, packages, and MLE modules. APEX applications are defined as metadata in the workspace and run on top of these schema objects, combining the application UI, security, data access, and server-side logic in one database-backed environment.
...
* View the About APEX page:
    ...
    - In the lower-left corner, click the **Help** icon.
    - Select **About** from the Help menu. The About APEX page appears.

  ![version](images/version.png)

### Where to Run the Lab
You can run this lab in any Oracle AI Database 26ai environment with Oracle APEX 26.1 installed. Supported options include Oracle APEX Application Development Service, the free development-only oracleapex.com service, an on-premises Oracle AI Database environment, or an Oracle AI Database deployment on a third-party cloud provider. For local development, you can also use Oracle Database Free, the Oracle Database App Developer VM, or a container-based setup with Podman or Docker, provided that APEX 26.1 is installed and configured.

The following sections describe how to get started with **Oracle APEX Application Development (APEX Service)**, an **Oracle Autonomous AI Database** cloud service, or the free **oracleapex.com** development service.

- **oracleapex.com** is a free, development-only service for learning, prototyping, and running workshops. It is not intended for production applications.

- **Oracle Autonomous AI Database** is a fully managed cloud database service with APEX included. It is well suited for learning, development, and production workloads, and can be scaled as required.

- **Oracle APEX Application Development (APEX Service)** is a managed service focused on APEX application development. It lets you build and deploy APEX applications without managing the underlying database infrastructure.

For this workshop, you can use any of these options, provided that Oracle APEX 26.1 is available.
...
- **Contributor** -  Sonja Meyer, Consulting Member of Technical Staff
- **Last Updated By/Date**: Sonja Meyer, Consulting Member of Technical Staff, June 2026